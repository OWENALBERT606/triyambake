  ...
  return (
    <section className="tm-root">
      ...
      <style>{`
        ...
        .blob-a { width:600px;height:600px; background:radial-gradient(#93c5fd,transparent); top:-200px;right:-150px; }
        .blob-b { width:400px;height:400px; background:radial-gradient(#bfdbfe,transparent); bottom:-100px;left:-80px; }
        ...
        .ey-line { display:inline-block; width:28px; height:2px; background:#93c5fd; border-radius:2px; }
        .tm-title {
          font-family: var(--ff-serif); font-size: clamp(2rem,4.5vw,3.2rem);
          font-weight: 800; color: #fff; line-height: 1.15;
          letter-spacing: -0.02em; margin: 0 0 1rem;
        }
        .tm-title em { color:#93c5fd; font-style:italic; }
        .tm-sub {
        ...
        .nav-btn:hover { background:#93c5fd20; border-color:#93c5fd; color:#93c5fd; }
        ...
        .dot.active { background:#93c5fd; width:24px; }
        ...
        .thumb-card.active { background:#93c5fd15; border-color:#93c5fd; }
        .thumb-avatar {
        ...
        .stat-value {
          ...
          color: #93c5fd; margin: 0.3rem 0 0.2rem;
