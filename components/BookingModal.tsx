    ...
    <>
      ...
      <style>{`
        ...
        .bm-drawer {
          ...
          box-shadow: -8px 0 60px #0f1f5c22;
        ...
        .bm-head-icon {
          ...
          background: linear-gradient(135deg, var(--bm-teal), #2563eb);
          display: grid; place-items: center; color: #fff;
          box-shadow: 0 4px 12px #1a3fa838;
        }
        ...
        .bm-input:focus { border-color:var(--bm-teal); box-shadow:0 0 0 3px #1a3fa818; }
        ...
        .bm-notice {
          ...
          background:var(--bm-teal-l); border:1px solid #bfdbfe;
        ...
        .bm-btn-primary {
          ...
          color:#fff; background:linear-gradient(135deg,var(--bm-teal),#2563eb);
          border:none; padding:0.7rem 1.6rem; border-radius:0.65rem;
          cursor:pointer; box-shadow:0 4px 16px #1a3fa838;
          transition:transform 0.18s, box-shadow 0.18s;
        }
        .bm-btn-primary:hover:not(:disabled) { transform:translateY(-2px); box-shadow:0 7px 22px #1a3fa858; }
        .bm-btn-primary:disabled { opacity:0.65; cursor:not-allowed; }
        .bm-btn-submit { background:linear-gradient(135deg,var(--bm-teal-d),var(--bm-teal)); }
        ...
        .bm-success-ring {
          ...
          background:var(--bm-teal-l); border:2px solid #bfdbfe;
