    ...
    <section className="appt-root">
      ...
      <style>{`
        .appt-root {
          ...
          position: relative;
          overflow: hidden;
          background: linear-gradient(160deg, #eff3ff 0%, #dbeafe 50%, #f8fafc 100%);
          padding: 5rem 1.5rem;
        }
        ...
        .blob1 { width:500px;height:500px; background:radial-gradient(#93c5fd,transparent); top:-150px;right:-100px; }
        .blob2 { width:400px;height:400px; background:radial-gradient(#bfdbfe,transparent); bottom:-100px;left:-80px; }
        ...
        .left-title em { color: #93c5fd; font-style: italic; }
        .left-sub {
          font-family: var(--ff-serif);
          font-size: 0.88rem;
          color: #94a3b8;
        ...
        .contact-item svg { color:#93c5fd; flex-shrink:0; }
        ...
        .btn-primary {
          ...
          box-shadow: 0 6px 20px #1a3fa838;
        }
        .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 10px 30px #1a3fa858; }
        .btn-submit { background: linear-gradient(135deg, #1535a0, var(--teal)); }
        ...
        .success-icon { color: var(--teal); animation: popIn 0.5s ease; }        @keyframes popIn { from{ transform:scale(0.5); opacity:0; } to{ transform:scale(1); opacity:1; } }
        .success-title {
