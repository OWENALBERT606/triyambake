...
export const metadata: Metadata = {
  ...
  description:
    "Contact Ggwaatiro Hospital in Bweyogerere, Kira Town Council. Call +256 772 428 467, email gwatiro@gmail.com, or visit us 10 km from Kampala. Emergency services 24/7.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Call +256 772 428 467 or email gwatiro@gmail.com. Located in Bweyogerere, 10 km from Kampala. Emergency care available 24/7.",
    url: "/contact",
